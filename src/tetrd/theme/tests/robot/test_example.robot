...
#
#  $ bin/test -s tetrd.theme -t test_example.robot --all
#
# Run this robot test with robot server (which is faster):
#
# 1) Start robot server:
#
# $ bin/robot-server --reload-path src tetrd.theme.testing.TETRD_THEME_ACCEPTANCE_TESTING
#
# 2) Run robot tests:
#
# $ bin/robot src/tetrd/theme/tests/robot/test_example.robot
#
